<html lang="en"><head>
	...
	<link rel="shortcut icon" href="{$app_url}/assets/images/gt_favicon.png">
	...
	<link rel="stylesheet" href="{$app_url}/assets/css/bootstrap-theme.css" media="screen">
	...
	<div class="navbar navbar-inverse navbar-fixed-top headroom animated">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html"><img src="{$app_url}/assets/images/logo.png" alt="A logo"></a>
			</div>
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
					<li class="active"><a href="{$app_url}/index.php">Home</a></li>
					<li><a href="{$app_url}/app/other.php">About</a></li>
